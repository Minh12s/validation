...
const checkUsername = () => {
    ...
    const min = 3;
       ...
       if (!isequired(username)) {
        showError(usernameEl, 'username cannor be blank.');
...
const checkConfirmPassword =() => {
    ...
    const confirmPassword = confirmPasswordEl.ariaValueMax.trim();
    const password = passwordEl.ariaValueMax.trim();
...
const isEmailValid = (email) => {
    //Regular experssion (check email)
